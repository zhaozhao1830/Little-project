...
function questionMarkSet()
{
    ...
    $(sSelecter).click(function(event){
        ...
        window.open("http://i.51job.com/resume/help.php?lang=c&module=" + module);
	});
}
            ...
            if(responseJson.check == 1)
            {
                ...
                var timer = setInterval(function(){
                    if (image.complete == true)
                    {
                        ...
                        {
                            if (isSmallPic){
                                $('#avatar_x1').val(size.height * 9 / 11);
                                $('#avatar_y1').val(size.height);
                                ...
                                $('#avatar_x1').val(size.ratio * image.height * 9 / 11);
                                $('#avatar_y1').val(size.ratio * image.height);
                            ...
                            if (isSmallPic){
                                ...
                                {
                                    $('#avatar_x1').val(296 * 9 / 11);
                                    $('#avatar_y1').val(296);
                                    var scale = 110 / (296);
                                }else{
                                    $('#avatar_x1').val(size.width);
                                    $('#avatar_y1').val(size.width * 11 / 9);
                                ...
                                if (size.ratio * image.width > (296 * 9 / 11))
                                {
                                    ...
                                    $('#avatar_x1').val(size.ratio * image.width);
                                    $('#avatar_y1').val(size.ratio * image.width * 11 / 9);
...
{
    var bResult = true;
    var sCheckById = arguments[0]?arguments[0]:""; 
    var oCheckSetting = [];
    var oCheckDetail = [];
    var aWhen = [];
    var iCheckResult = 0;
    oCheckSetting = aConfig[sModule]['validate'];
