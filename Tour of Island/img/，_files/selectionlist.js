    ...
    $.fn.selectionlist = function(options)
    {
        ...
        function listShow(p_bShow, p_sId)
        {
            if(p_bShow)
            {
                ...
                {
                    closeAllFloatDiv($("#" + p_sId),$("#" + p_sId).parents('.flboxwp,.ln,.c,.box'));
                }
                $("#" + p_sId).addClass("on");
                $("#" + p_sId).parents('.flboxwp,.ln,.c,.box').attr("float-index", "true").css("z-index", "4");
            ...
            else
            {
                ...
                $("#" + p_sId).parents('.flboxwp,.ln,.c,.box').attr("float-index", "false").css("z-index", "");
